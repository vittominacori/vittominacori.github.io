...
meta: 
    ...
    - name: description
      ...
      content: I'm a Software Engineer continually seeking and testing new tools and opportunities for innovation. I'm building next-generation Web Apps and Smart Contracts.
...
I live in Catania, and I'm passionate about web applications, blockchain technologies and development tools.

## Experience

I have been involved as a technical expert in several European, national and regional research projects.
I have been head of development for several modern Web Applications and Services used by thousands of users around the world.  

Now, I'm building next-generation Web Apps and Smart Contracts supporting developers, companies, and projects worldwide, in accessing the fast-growing Blockchain ecosystem and the Decentralized Web.
...
```
NONCEPT is building Blockchain based applications and Smart Contracts, supporting amazing projects to access the Decentralized Web.
NONCEPT develops decentralized applications and platforms covering different fields like ERC20 Tokens, DeFi, NFTs, DAOs and more.
```
...
```
FriendsFingers is an open-sourced Decentralized Application built on Smart Contracts running on the Ethereum Blockchain. 
```
...
```
CharityStars is a groundbreaking international fundraising platform for non-profit organizations that offers one destination for all - Auctions, Buy Now, Sweepstakes and Event/Gala Technology.
CharityStars is marketplace where celebrities and brands can donate experiences or items to raise money for charitable causes.
```
[www.charitystars.com](https://www.charitystars.com)

### PED

**Senior Web and Blockchain Developer, DevOps**
...
It is available on Ethereum, Polygon Network, Binance Smart Chain and Avalanche.
```
[vittominacori.github.io/token-generator/](https://vittominacori.github.io/token-generator/)  
...
```
Development of a platform for users profiling and for users recommendation based on user attention on queries or learning resources.
```
...
* Blockchain, Smart Contracts, DApps, NFT, DeFi, DAO
* Ethereum, Binance Smart Chain, Polygon Network, Avalanche, EVM
* Solidity, Web3.js, Truffle, Hardhat, MetaMask, OpenZeppelin
* ERC-20, ERC-721, ERC-1363, BEP-20 
* Web Applications and Integrated Systems 
* RESTful Web Services and APIs 
* SQL and NoSQL Databases 
* PHP, Node.js, JavaScript 
* Semantic Web and Ontology Engineering, JSON-LD, RDFs and Microdata 
* Social, Payment and 3rd-party APIs 
* DevOps, Amazon Web Services, Apache, nginx, Git
